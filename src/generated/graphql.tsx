...
export type LaunchinfoQueryVariables = Exact<{ [key: string]: never; }>;
...
export type LaunchinfoQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'mission_id' | 'launch_success' | 'launch_year' | 'launch_date_unix' | 'launch_date_utc'>
  )>>> }
);
